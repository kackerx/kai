...
[![golangci-lint](https://github.com/kackerx/kai/actions/workflows/golangci-lint.yml/badge.svg)](https://github.com/kackerx/kai/actions/workflows/golangci-lint.yml)
...
## Swagger UI
- GitHub Page: https://kackerx.github.io/kai/docs/swagger-ui/
...
make skaffold-dev
```
## Starting tunnel via minikube for service kai-web
```
